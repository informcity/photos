...
let arrGoods = [
  ...
  new Goods("5", "79", "СВЕТР 'дж. байа'(M)", "200", "150", "100"),
  new Goods("6", "35", "СВЕТР 'кулис без вор'(M)", "210", "160", "105"),
  new Goods("7", "104", "СВЕТР 'ямак бот'(3XL)", "500", "375", "250"),
  ...
  new Goods("49", "42", "ФУТБОЛКА 'бондю-томми'(S,S)", "160", "120", "80"),
...
class EmpTable {
  constructor(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
      ...
      this.tr.appendChild(this.td);
      this.td = document.createElement("td");
      this.td.innerHTML = `<a id="${arr[i].number}" href="#sa">ФОТО</a>`;
      this.tr.appendChild(this.td);
